# Relation Integrity / Qualification — tiny frozen fixture + scoring package revision 0.3 (2026-09-26)

**Status:** `OWNER-AUTHORIZED BOUNDED REVISION · REVISION 0.3 · FROZEN FOR BOUNDED RE-REVIEW · DOCUMENT-ONLY · NOT EXECUTED · NO EXPERIMENT ID · NOT CANON · NOT RUNTIME AUTHORIZATION`

**Package revision:** `0.3`
...
- R4: scopes F-P1 identity explicitly to Registry R so the positive control no longer widens registry identity into an unscoped world-identity claim.
...
## 9. Positive control F-P1 — explicit Registry-R-scoped identity support
...
Frozen gold does **not** contain an unqualified world-level `SAME_ENTITY(A,B)`. The positive control tests preservation of the scoped Registry-R relation only. Registry identity does not silently become global/world identity.
...
Revision 0.3 still does not freeze:
